    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-slate-800">
        <ul class="space-y-2 font-medium">
            ...
            <li x-data="{ isOpen: false }">
                ...
                <ul x-show="isOpen" id="dropdown-example" class="py-2 space-y-2">
                    <li>
                        <a href="/admin/media"
                    ...
                    <li>
                        <a href="/admin/library"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Library</a>
                    </li>
                </ul>
            </li>
            <li>
