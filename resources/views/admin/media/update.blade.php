        ...
        <div>
            ...
            <div class="relative max-w-sm mb-5" x-data="{ date: '' }" x-init="flatpickr($refs.input, { dateFormat: 'Y-m-d' })">
                ...
                <input x-ref="input" type="text" x-model="date"
                    ...
                    placeholder="{{ $media->release_date }}" value="{{ $media->release_date }}">
            </div>
            <div class="mb-5">
            ...
            <select name="mediaType" id="mediaType" required
                ...
                <option value="movie" {{ $media->mediaType == 'movie' ? 'selected' : '' }}>Movie</option>
                <option value="tv" {{ $media->mediaType == 'tv' ? 'selected' : '' }}>TV Show</option>
            </select>
